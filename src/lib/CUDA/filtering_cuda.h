#ifndef MEANFIELD_FILTERING_CUDA_HEADER
#define MEANFIELD_FILTERING_CUDA_HEADER
	...
	namespace CUDA {
		namespace Filtering {
			struct GaussianFilterSeparable {
				...
				*/
				static void applyXDirection(const float *input, float *output, const float *kernel, float sd, int dim, int W, int H);
				...
				* @param H First dimension of the tensor.
				*/
				static void applyYDirection(const float *input, float *output, const float *kernel, float sd, int dim, int W, int H);
			};
